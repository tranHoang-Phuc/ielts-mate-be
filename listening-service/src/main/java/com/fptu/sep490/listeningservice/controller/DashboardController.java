...
public class DashboardController {
    ...
    @PreAuthorize("hasRole('CREATOR')")
    public ResponseEntity<BaseResponse<List<ReportQuestionTypeStats>>> getQuestionTypeStats(
            @RequestParam("fromDate") LocalDate fromDate,
            @RequestParam("toDate") LocalDate toDate,
            HttpServletRequest request) {
        List<ReportQuestionTypeStats> questionTypeStats = dashboardService.getQuestionTypeStats(fromDate, toDate, request);
    ...
    @PreAuthorize("hasRole('CREATOR')")
    public ResponseEntity<BaseResponse<List<ReportQuestionTypeStatsWrong>>> getQuestionTypeStatsWrong(
            @RequestParam("fromDate") LocalDate fromDate,
            @RequestParam("toDate") LocalDate toDate,
            HttpServletRequest request) {
        List<ReportQuestionTypeStatsWrong> questionTypeStatsWrong = dashboardService.getQuestionTypeStatsWrong(fromDate, toDate, request);
