...
@OpenAPIDefinition(info = @Info(title = "Identity Services", description = "Identity API documentation", version = "1.0"),
...
@SecurityScheme(name = "oath2_bearer", type = SecuritySchemeType.OAUTH2,
